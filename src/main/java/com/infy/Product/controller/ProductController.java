...
public class ProductController {
	...
	@GetMapping(value = "/api/productsList",  produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(value = "/api/productsById/{prodid}",  produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    //Fetch subscriptions using subid
	...
	//Disable products using seller id
	...
	//updating stock using product id
		...
		// Check stock before order if availabe
